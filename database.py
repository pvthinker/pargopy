...
def update_argo_global():
    ...
    # TO DO: il faut penser à vectoriser la function get_tag = qu'elle accepte des listes
    for wmo in idx:
    ...
    # TO DO: idem = boucle lourdingue, travailler sur tous les indices d'un coup
    new_prof_idx = []
